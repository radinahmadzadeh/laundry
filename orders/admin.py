...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id', 'customer', 'status', 'shamsi_date', 'delivery_date', 'total_price', 'is_paid', 'courier_requested', 'courier_dispatched', 'actions_buttons')
    list_filter = ('status', 'is_paid', 'courier_requested')
